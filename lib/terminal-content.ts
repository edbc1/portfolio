...
export const projects: Record<string, TermProject> = {
  rocapine: {
    ...
    images: [
      { src: "/projects/rocapine/1.png", caption: "app showcase" },
      { src: "/projects/rocapine/2.png", caption: "app showcase" },
      { src: "/projects/rocapine/3.png", caption: "app showcase" },
      { src: "/projects/rocapine/4.png", caption: "app showcase" },
      { src: "/projects/rocapine/5.png", caption: "app showcase" },
      { src: "/projects/rocapine/6.png", caption: "studio" },
    ],
    links: [{ label: "rocapi.ne", url: "https://rocapi.ne/" }],
  },
  pimento: {
    id: "pimento",
    title: "pimento",
